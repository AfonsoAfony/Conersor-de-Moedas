...
fetchApiExchangeRate();
    ...
    return (
        ...
        <div className="flex flex-col items-center">
            ...
            <label htmlFor="de" className="text-base">Converter de:</label>
            <Select damoeda={daMoeda} onChange={(e) => setDaMoeda(e.target.value)} name="de" id="de" />

            <label htmlFor="para" className="text-base">Para:</label>
            <Select onChange={(e)=>setParaMoeda(e.target.value)} name="para" id="para"/>
            
            <input type="number" value={quantia} onChange={(e) => setQuantia(e.target.value)} className=" bg-white text-black rounded w-80 h-10 text-center my-5" placeholder="Digite o valor:" />
